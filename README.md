...
decomposes the problem into two binary decisions: first identifying whether a borrower
will default, then classifying confirmed defaults as mild or severe. Five models compete
